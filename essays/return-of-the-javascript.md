...
Of course, I could see how that flexibility could be a disadvantage. For example, it would be very easy to change a variable that's initally an array into an integer which could accidentally break your program.
